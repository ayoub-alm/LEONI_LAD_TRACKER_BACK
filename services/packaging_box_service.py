...
class PackagingBoxService:
    @staticmethod
    def create_packaging_box(id,line_id, quantity, harness_id, status, created_by, barcode):
        packaging_box = PackagingBox(line_id=line_id, quantity=quantity, harness_id=harness_id,
    ...
    @staticmethod
    def update_packaging_box(box_id, line_id=None, quantity=None, harness_id=None, status=None, created_by=None,
                             barcode=None):
        ...
        if packaging_box:
            ...
            if quantity is not None:
                packaging_box.quantity = quantity
